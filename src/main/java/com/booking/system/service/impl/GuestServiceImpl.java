...
import com.booking.system.file.ExcelExportUtils;
...
public class GuestServiceImpl implements GuestService {
    ...
    @Override
	public List<Guest> exportGuestToExcel(HttpServletResponse response) throws IOException {
		List<Guest> customers = guestRepository.findAll();
